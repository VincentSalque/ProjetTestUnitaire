...
{
    [Theory(DisplayName = "Crée une pièce de valeur valide")]
    [InlineData(1)]
    [InlineData(2)]
    [InlineData(5)]
    [InlineData(10)]
    ...
    {
        Assert.Equal(valueInCents, new Coin(valueInCents).Value);
    }

    [Theory(DisplayName = "Crée une pièce de valeur invalide")]
    [InlineData(0)]
    [InlineData(3)]
    [InlineData(4)]
    [InlineData(6)]
